...
/**
 * Retrieve the value for the field in the specified instance of the object.
 *
 * @since 0.981.0
 */
@BallerinaFunction(
...
public class GetValue extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        BValue value = (BValue) objInstance.getMap().get(fieldInfo.get(FIELD_INFO_IDENTIFIER).stringValue());
        context.setReturnValues(value);
    }
}
