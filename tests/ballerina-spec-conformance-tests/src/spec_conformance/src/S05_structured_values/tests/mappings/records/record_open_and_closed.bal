...
function testClosedRecord() {
    ...
    utils:assertPanic(function () { updateClosedRecordWithOneField(r1, 1); }, "{ballerina/lang.map}KeyNotFound",
...
function testOpenRecordWithSpecifiedRestType() {
    ...
    utils:assertPanic(function () { updateOpenRecordTwo(r1, s1); }, MAP_INHERENT_TYPE_VIOLATION_REASON,
